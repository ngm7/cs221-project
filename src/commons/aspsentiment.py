...
#This function uses the input file with the text to pre-process and writes the processed text in another output file
def preProcessing(inputFileStr,outputFileStr,printResult):
    ...
    outputFile.close()
'hbn=]' \
''#This method tokenizez the text using sentence tokenization taking data from the pre
